    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <ul class="menu-nav">
                ...
                <li class="menu-item <?php if (Request::segment(1) == '/' && Request::segment(2) == '/') {
                    echo 'menu-item-active';
                    } ?>" aria-haspopup="true">
                    <a href="{{ route('frontend') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                ...
                <li class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'gallaries') {
                    echo 'menu-item-active';
                    } ?>" aria-haspopup="true">
                ...
                <li class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'extra_services') {
                    echo 'menu-item-active';
                    } ?>" aria-haspopup="true">
                    <a href="{{route('extraservices.index')}}" class="menu-link">
                        <span class="svg-icon menu-icon">
                ...
                <li class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'testimonials') {
                    echo 'menu-item-active';
                    } ?>" aria-haspopup="true">
                ...
                {{-- <li class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'order_services') {
                    echo 'menu-item-active';
                    } ?>" aria-haspopup="true">
                    <a href="{{ route('service_orders.index') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                        ...
                        <span class="menu-text">Order Services</span>
                    </a>
                </li>

                <li class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'extra_service_orders') {
                    echo 'menu-item-active';
                    } ?>" aria-haspopup="true">
                    <a href="{{ route('extra_service_orders.index') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                        ...
                        <span class="menu-text">Order Extra Services</span>
                    </a>
                </li> --}}
