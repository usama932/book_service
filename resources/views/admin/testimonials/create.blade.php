        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
          ...
          <div class="d-flex align-items-baseline flex-wrap mr-5">
            ...
            <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
              ...
              <li class="breadcrumb-item text-muted">
                <a href="" class="text-muted">Add Testimonial</a>
              </li>
            </ul>
            <!--end::Breadcrumb-->
          </div>
        ...
        <div class="card card-custom card-sticky" id="kt_page_sticky_card">
          <div class="card-header" style="">
            <div class="card-title">
              <h3 class="card-label">Testimonial Add Form
                <i class="mr-2"></i>
            ...
            <div class="card-toolbar">
              ...
              <div class="btn-group">
                <a href="{{ route('testimonials.store') }}"  onclick="event.preventDefault(); document.getElementById('testimonials_add_form').submit();" id="kt_btn" class="btn btn-primary font-weight-bolder">
          ...
          <!--begin::Form-->
            {{ Form::open([ 'route' => 'testimonials.store','class'=>'form' ,"id"=>"testimonials_add_form", 'enctype'=>'multipart/form-data']) }}
              @csrf
              <div class="row">
